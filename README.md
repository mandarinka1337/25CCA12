...
# ССА-12 · Алгоритмизация

**Лабораторные работы по дисциплине «Алгоритмизация и программирование» — группа ССА-12**
...
Все лабораторные работы выполняются на **трёх языках программирования**:
...
|------|------|------------|
| **10.09.2026** | [`2026-09-10/`](./2026-09-10/!25-ССА-12_Algo) | Полный комплект: C#, Delphi, Python |
